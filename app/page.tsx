        ...
        <div className="max-w-7xl! mx-auto! px-6! relative z-10!">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16! gap-8!">
            <div className="text-right">
              ...
              <h2 className="text-5xl! font-black text-white mb-6!">آخرین نبض <span className="text-transparent bg-clip-text bg-gradient-to-l from-indigo-400 to-purple-400">دنیای برندینگ</span></h2>
            </div>
      ...
      <section id="award" className="py-32! relative">
        <div className="max-w-5xl! mx-auto! px-6!">
          <div className="bg-gradient-to-br from-indigo-900/40 to-purple-900/40! border border-indigo-500/20 rounded-[3rem]! p-12! md:p-20! relative overflow-hidden backdrop-blur-xl text-center">
            ...
            <h2 className="text-4xl! md:text-6xl! font-black mb-8!">🏆 خـلاتی <span className="text-indigo-400">HATAW</span></h2>
            ...
            <div className="flex flex-wrap justify-center gap-6!">
              <button className="px-10! py-4! bg-white text-black rounded-2xl! font-black hover:bg-indigo-500 hover:text-white transition-all">به چالش بپیوندید</button>
