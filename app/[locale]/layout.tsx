...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const content = {
    en: {
      ...
      description: "Hataw Group helps businesses transition from fragmentation to a unified brand system through strategic identity, infrastructure, and content engines.",
    },
    ku: {
      title: "گرووپی هەتاو | گۆڕینی بزنس بۆ براند",
      description: "گرووپی هەتاو یارمەتی بزنسەکان دەدات لە پارچەپارچەبوونەوە بگۆڕێن بۆ سیستەمێکی براندی یەکگرتوو لە ڕێگەی ناسنامەی ستراتیژی و ژێرخانی دیجیتاڵی.",
    }
  };
