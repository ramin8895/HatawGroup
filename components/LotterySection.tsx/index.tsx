  ...
  return (
    <section id="award" className="py-32! relative!">
      <div className="max-w-5xl! mx-auto! px-6!">
        {/* باکس اصلی با گرادینت طلایی متالیک و مشکی */}
        <div className="bg-gradient-to-br! from-[#B8860B]/20! to-black/60! border! border-[#D4AF37]/20! rounded-[3rem]! p-12! md:p-20! relative! overflow-hidden! backdrop-blur-xl! text-center! shadow-[0_20px_50px_-20px_rgba(212,175,55,0.2)]">
          {/* آیکون کاپ بزرگ در پس‌زمینه با رنگ طلایی ملایم */}
          <div className="absolute! top-0! right-0! p-8! text-[#D4AF37]! opacity-10! pointer-events-none!">
            <Trophy size={200} />
          </div>
          ...
          {/* نشان مبلغ جایزه با استایل طلایی درخشان (D4AF37) */}
            ...
            <AnimatePresence mode="wait">
              {status === "loading" ? (
                ...
                >
                  ...
                  />
                  <Zap
                    className="absolute! right-5! top-1/2! -translate-y-1/2! text-[#D4AF37]! group-focus-within:animate-pulse!"
                    size={24}
                  />
