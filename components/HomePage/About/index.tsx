...
const AboutComponents = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl! text-8xl! mx-auto! px-6! relative z-10!">
        <div
        ...
        >
          ...
          <motion.div
            className={`relative group ${
              isRTL ? "order-2 lg:order-1!" : "order-2!"
            }`}
            variants={fadeInUp}
          >
            <div className="relative rounded-[3rem]!  overflow-hidden border border-[#E0E0E0]/10! bg-[#121212]! p-3! backdrop-blur-sm transition-all duration-500 group-hover:border-[#D4AF37]/40">
              ...
              <div
                ...
                } bg-gradient-to-br from-[#D4AF37] via-[#F5E1A4] to-[#B8860B] p-7! rounded-3xl! shadow-[0_20px_50px_rgba(212,175,55,0.3)] hidden md:block!`}
              >
                <div
                ...
                >
                  ...
                  <div className={isRTL ? "text-right" : "text-left"}>
                    <p className="text-[#121212] font-black text-3xl! leading-none!">
                      15+
                    </p>
                    <p className="text-[#121212]/70 font-bold text-[11px] uppercase tracking-tighter!">
                      {t("yearsExp")}
                    </p>
                  </div>
                </div>
            ...
            <div
              ...
              } w-40! h-40! border-t-2! ${
                isRTL ? "border-l-2!" : "border-r-2!"
              } border-[#E0E0E0]/10! group-hover:border-[#D4AF37]/30 transition-colors ${
                isRTL ? "rounded-tl-[4rem]!" : "rounded-tr-[4rem]!"
              } -z-10!`}
            ></div>
          </motion.div>
          ...
          <motion.div
            className={`space-y-8! ${
              isRTL ? "text-right order-1 lg:order-2!" : "text-left order-1!"
            }`}
            variants={fadeInUp}
          >
            <div className="space-y-4!">
              ...
              >
                {!isRTL && (
                  <span className="w-16! h-px! bg-linear-to-r from-[#D4AF37] to-transparent"></span>
                )}
                <span className="text-[#D4AF37] text-xs! font-black tracking-[0.3em] uppercase">
                  {t("badge")}
                </span>
                {isRTL && (
                  <span className="w-16! h-px! bg-linear-to-l from-[#D4AF37] to-transparent"></span>
                )}
              </div>
              <h3 className="text-5xl md:text-6xl! font-black text-[#FFFFFF] leading-[1.1]!">
                {t.rich("title", {
                  br: () => <br />,
                  span: (chunks) => (
                    <span className="text-transparent bg-clip-text text-3xl! bg-linear-to-l from-[#E0E0E0] via-[#D4AF37] to-[#E0E0E0]">
                      {chunks}
                    </span>
                  ),
                })}
            ...
            <p className="text-[#E0E0E0]/60 text-xl! leading-relaxed! font-light">
              {t.rich("description", {
                bold: (chunks) => (
                  <span className="text-[#D4AF37] font-bold">{chunks}</span>
                ),
              })}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5! gap-x-8! py-6!">
              {[t("feat1"), t("feat2"), t("feat3"), t("feat4")].map(
                (item, index) => (
                  <div
                    key={index}
                    className={`flex items-center gap-3! text-[#E0E0E0]/80 group/item ${
                      isRTL ? "justify-end" : "justify-start"
                    }`}
                  >
                    {!isRTL && (
                    ...
                    <span className="font-semibold group-hover/item:text-[#D4AF37] transition-colors">
                      {item}
                    </span>
                    {isRTL && (
                      <div className="p-1! rounded-full! bg-[#D4AF37]/5! border border-[#D4AF37]/10! group-hover:border-[#D4AF37]/40 transition-all">
