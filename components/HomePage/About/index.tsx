...
const AboutComponents = () => {
  ...
  return (
    <motion.section
      ...
      variants={container}
    >
      {/* پلت رنگی در افکت‌های نوری پس‌زمینه */}
              ...
              <div className="absolute bottom-10! -right-6! md:right-10! bg-gradient-to-br from-[#D4AF37] via-[#F5E1A4] to-[#B8860B] p-7! rounded-3xl! shadow-[0_20px_50px_rgba(212,175,55,0.3)] hidden md:block!">
                <div className="flex items-center gap-4!">
                  ...
                  <div>
                    ...
                    <p className="text-[#121212]/70 font-bold text-[11px]! uppercase tracking-tighter!">ساڵان ئەزموون</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Decorative Frame - Silver to Gold transition */}
            <div className="absolute -top-6! -left-6! w-40! h-40! border-t-2! border-l-2! border-[#E0E0E0]/10! group-hover:border-[#D4AF37]/30 transition-colors rounded-tl-[4rem]! -z-10!"></div>
          </motion.div>
          ...
          <motion.div className="space-y-8! text-right order-1 lg:order-2!" variants={fadeInUp}>
            <div className="space-y-4!">
              ...
              <h3 className="text-5xl! md:text-6xl! font-black text-[#FFFFFF] leading-[1.1]!">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-l from-[#E0E0E0] via-[#D4AF37] to-[#E0E0E0]">بەردەوام دەبن</span>
              </h3>
            </div>

            <p className="text-[#E0E0E0]/60 text-xl! leading-relaxed! font-light">
              لە <span className="text-[#D4AF37] font-bold">Hataw Group</span>، باوەڕمان وایە هەموو بازرگانییەک شایەنی ئەوەیە ببێتە براندێکی بەهێز. ڕێبازی ستراتیژیمان توێژینەوەی بازاڕی قووڵ و داهێنانی پیشەیی تێکەڵ دەکات.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5! gap-x-8! py-6!">
              {[
                ...
                <div key={index} className="flex items-center justify-end gap-3! text-[#E0E0E0]/80 group/item">
